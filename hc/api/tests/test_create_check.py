...
class CreateCheckTestCase(BaseTestCase):
    ...
    def test_it_handles_invalid_json(self):
        ...
        r = self.client.post(self.URL, 'abcdef', content_type="application/json")
